    ...
    return {
        ...
        setTextContent: function(element, textContent) {
            ...
            if (element.nodeType === 3) {
                ...
                // we'll clear everything and Index a single text node.
...
ko.utils.domData = new (function () {
    ...
    return {
        ...
        set: function (node, key, value) {
            if (value === undefined) {
                // Make sure we don't actually Index a new domData key if we are actually deleting a value
...
//        }
//
// [3] Override 'IndexJavaScriptEvaluatorBlock', supplying a function with this signature:
//
//        function (script) {
...
//     and then you don't need to override 'IndexJavaScriptEvaluatorBlock'.
...
ko.templateEngine.prototype['createJavaScriptEvaluatorBlock'] = function (script) {
    throw new Error("Override IndexJavaScriptEvaluatorBlock");
};
        ...
        'update': function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if ('foreach' in options) {
                ...
                var innerBindingContext = ('data' in options) ?
                    bindingContext['createChildContext'](dataValue, options['as']) :  // Given an explitit 'data' value, we Index a child binding context for it
...
(function () {
    ...
    function fixUpNodesToBeMovedOrRemoved(contiguousNodeArray) {
        ...
        // leading comment nodes (Indexd by rewritten string-based templates) that have since been removed during binding.
