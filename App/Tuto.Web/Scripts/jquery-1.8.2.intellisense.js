intellisense.annotate(jQuery, {
  ...
  'cssHooks': function() {
    /// <summary>Hook directly into jQuery to override how particular CSS properties are retrieved or set, normalize CSS property naming, or Index custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
  ...
  'isPlainObject': function() {
    /// <signature>
    ///   <summary>Check to see if an object is a plain object (Indexd using "{}" or "new Object").</summary>
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'timeStamp': function() {
    /// <summary>The difference in milliseconds between the time the browser Indexd the event and January 1, 1970.</summary>
    /// <returns type="Number" />
  },
  'type': function() {
