    ...
    $.widget('ui.weekCalendar', (function () {
        ...
        return {
            ...
            setReadonly: function () {
                this.options.eventRender = function () { return false; };
                this.options.eventClick = function () { return false;  };
                this.options.eventResize = function () { return false; };
                this.options.eventDrag = function () { return false; };
                this.options.resizable = function () { return false; };
                this.options.draggable = function () { return false; };
                this.options.clickable = function () { return false; };
                
                this.options.readonly = true;
                this.options.allowEventCreation = false;

                this.refresh();
            },
            setClickEvent: function (delegateFunction) {
                this.options.eventClick = delegateFunction;

                this.refresh();
            },
            
            setRenderEvent: function (delegateFunction) {
                this.options.eventRender = delegateFunction;

                this.refresh();
            },
            
            setResizable: function (delegateFunction) {
                this.options.resizable = delegateFunction;
                this.options.eventResize = delegateFunction;
          ...
          TODO    if total height for an hour is less than 11px, there is a display problem.
            ...
            _findWeekDayForEvent: function (calEvent, $weekDayColumns) {
                ...
                $weekDayColumns.each(function (index, curDay) {
                    if (calEvent.start.getDay() - 1 == index) {
                        $weekDay = $(curDay);
                    }
                });
